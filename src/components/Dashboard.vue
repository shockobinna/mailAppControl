<template>
  <div>
      ...
      <div class="dashdisplay">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-3">
              <radial-graph
                v-if="getTotalA && getTotalB && getTotalC"
                :getA="this.getTotalA"
                :getB="this.getTotalB"
                :getC="this.getTotalC"
              />
          ...
          <i
            class="fa fa-list text-secondary"
            aria-hidden="true"
            style="font-size: 1em"
          ></i>
          Ver toda encomenda de cada bloco
        </div>
      </div>
    </div>
      ...
      <div class="searchbox">
        <div class="input-group">
          <input
            ...
            type="search"
            placeholder="Pesquisar encomenda pelo número do apartamento"
            value="search"
    ...
    <div class="container-fluid mt-3">
      <div class="bloco">
        <h1>Bloco {{ this.bloco_identifier }}</h1>
      </div>
    </div>
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="bloco in filterEncomenda" :key="bloco.id">
                ...
                <td v-for="(value, key) in bloco.encomenda" :key="key">
                  {{ value.data_recebida }}
                </td>
                <td>
                  <button
                    ...
                    @click.prevent="entregarEncomenda(bloco)"
                  >
...
const baseEntregaA = "http://localhost:3001/encomendaEntregadaBlocoA";
const baseEntregaB = "http://localhost:3001/encomendaEntregadaBlocoB";
const baseEntregaC = "http://localhost:3001/encomendaEntregadaBlocoC";
export default {
  components: {
    AppHeader,
    BlocoGraph,
  ...
  methods: {
    ...
    getSearch(search){
      ...
      return this.blocos = this.blocos.filter(bloco =>{
        bloco.apartamento === search || bloco.nome === search
